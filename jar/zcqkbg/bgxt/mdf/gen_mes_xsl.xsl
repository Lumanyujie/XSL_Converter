...
!!              program.
-->
  <xsl:import href="../mdf/utm.xsl"/>
  <xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes"/>
  <xsl:param name="language" select="'english'"/>
  <xsl:param name="gdata" select="'file:/C:/Documents and Settings/Administrator/桌面/20151017/康主任/zcqkbg/bgxt/gdata'"/>
        ...
        <xsl:element name="xsl:if">
          ...
          <xsl:element name="xsl:if">
            ...
            <xsl:element name="xsl:if">
              ...
              <xsl:element name="xsl:text">&lt;class ='qita'&gt;</xsl:element>
              <xsl:element name="xsl:value-of">
            ...
            <!-- 整个表格边框样式-->
            <xsl:element name="xsl:text">&lt;table border="1" cellspacing="0" cellpadding="1" width="97%" class='table_all'&gt;</xsl:element>
