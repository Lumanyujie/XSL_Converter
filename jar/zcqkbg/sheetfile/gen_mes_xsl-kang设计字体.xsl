...
!!              program.
-->
  <xsl:import href="file:/D:/jtls/mdf/utm.xsl"/>
  <xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes"/>
  <xsl:param name="language" select="'english'"/>
  <xsl:param name="gdata" select="'file:/D:/jtls/gdata'"/>
  ...
  <xsl:template name="make-message-template">
    ...
    <xsl:element name="xsl:stylesheet">
      ...
      <xsl:element name="xsl:template">
        ...
        <xsl:text>&lt;html class="defaultcss"&gt;&lt;style type='text/css'&gt;.rest{font-size:20px;font-family:黑体;font-weight:bold;text-align:center; line-height:50px; }.paragraph{text-indent:35px;font-size:16px;font-family:'宋体';text-align:left;line-height:20px; }.table_td{ text-indent:0px;font-size:14px;font-family:'宋体';border-color:#000000;border-style:solid;border-width:1px; line-height:25px; }.playcode{text-indent:0px;font: 14pt '楷体_GB2312'; font-weight: bold; color: black; text-align:left;line-height:30px; }.table_th{ text-indent:0px;text-align:center;font-family:黑体;font-size:12pt;color:black; border-width:1px;border-color:#000000;border-style:solid; line-height:30px; }.title1{ text-indent:0px;font-size:18pt;font-family:黑体; font-weight: bold; color: black; text-align:left; line-height:40px; }.title2{ text-indent:0px;font-size:16pt;font-family:黑体; font-weight: bold; color: black; text-align:left; line-height:30px; }.title{ text-indent:0px;font-size:20pt;font-family:方正大标宋简体; color:black; text-align:center; line-height:50px; }.table_name{text-indent:0px;font-size:16pt;font-family:方正大标宋简体; font-weight: bold; color:black; text-align:center; line-height:30px; }.table_all{ border-color:#666666;border-style:solid;border-width:2px;margin-left:15px; line-height:20px; }.secl{text-indent:0px;font: 16pt '楷体_GB2312'; font-weight: bold; color: red; text-align:left;line-height:30px; float:right; }.defaultcss{ text-indent:35px;font-size:16px;font-family:'宋体';text-align:left;line-height:25px; }.task{text-indent:0px;font: 14pt '楷体_GB2312'; font-weight: bold; color: black; text-align:left; line-height:30px; }.headDiv{text-indent:0px;font: 14pt '楷体_GB2312'; font-weight: bold; color: black; text-align:left;line-height:30px; }.text{ text-indent:0px;font-size:14pt;font-family:宋体; color:black; text-align:left; line-height:30px; }.sel{text-indent:0px;font: 16pt '方正大标宋简体'; font-weight: bold; color: black; text-align:left;line-height:30px; }&lt;/style&gt;</xsl:text>
        <xsl:value-of select="$cr"/>
  ...
  <xsl:template name="process-sub">
    ...
    <xsl:element name="xsl:for-each">
      <xsl:attribute name="select">
        <xsl:value-of select="concat('S',@n)"/>
      </xsl:attribute>
...
-->
  <xsl:template name="process-group">
    ...
    <xsl:element name="xsl:for-each">
      <xsl:attribute name="select">
        <xsl:value-of select="concat('G',@n,'/R')"/>
      </xsl:attribute>
      <!-- Call the recursive template that will create the stylesheet commands
         for the children nodes -->
      <xsl:call-template name="process-section">
        ...
        <xsl:when test="@w != '' or @p != '' or @s != '' or @j != '' or @t = 'd' or @t = 'f'">
          ...
          <xsl:element name="xsl:call-template">
            <xsl:attribute name="name">
              <xsl:value-of select="concat('format-',$type,'-',$just)"/>
            </xsl:attribute>
            <xsl:element name="xsl:with-param">
                  ...
                  <xsl:when test="string-length($normalized-text)!=0 and starts-with($first-word,'caption')=false() and starts-with($first-word,'__start_table')=false()">
                    <xsl:element name="xsl:call-template">
                      ...
                      <xsl:element name="xsl:with-param">
                        ...
                        <xsl:if test="starts-with($normalized-text,'|')">1</xsl:if>
                        <xsl:if test="starts-with($normalized-text,'|')=false()">0</xsl:if>
                      </xsl:element>
                    </xsl:element>
                  </xsl:when>
          ...
          <xsl:element name="xsl:value-of">
            <xsl:attribute name="select">
              <xsl:call-template name="get-xpath">
                <xsl:with-param name="context" select="$rel-pos"/>
    ...
    <xsl:element name="xsl:call-template">
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          ...
          <xsl:attribute name="name">
            <xsl:value-of select="concat(@n,'_FUN')"/>
          </xsl:attribute>
        </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:for-each select="$context/*">
        <xsl:element name="xsl:with-param">
          ...
          <xsl:attribute name="name">
            <xsl:value-of select="concat('arg',string(position()))"/>
          </xsl:attribute>
  ...
  <xsl:template name="ws-function">
    ...
    <xsl:element name="xsl:template">
      ...
      <xsl:element name="xsl:if">
        ...
        <xsl:element name="xsl:if">
          ...
          <xsl:element name="xsl:if">
            ...
            <xsl:element name="xsl:if">
              ...
              <xsl:element name="xsl:text">&lt;p align="center" style="font-family:黑体;font-weight:bold"&gt;</xsl:element>
              <xsl:element name="xsl:value-of">
                <xsl:attribute name="select">normalize-space($caption)</xsl:attribute>
              </xsl:element>
              <xsl:element name="xsl:text">&lt;/p&gt;&lt;br/&gt;</xsl:element>
              <xsl:element name="xsl:call-template">
                <xsl:attribute name="name">set-caption</xsl:attribute>
                <xsl:element name="xsl:with-param">
                  <xsl:attribute name="name">caption</xsl:attribute>
            ...
            <!-- 整个表格边框样式-->
            <xsl:element name="xsl:text">&lt;table border="1" cellspacing="0" cellpadding="1" width="90%" class='table_all'&gt;</xsl:element>
            <xsl:element name="xsl:text">&lt;tr style="word-wrap:break-word"&gt;</xsl:element>
            <xsl:element name="xsl:call-template">
            ...
            <xsl:element name="xsl:text">&lt;/tr&gt;</xsl:element>
            <xsl:element name="xsl:text">&lt;tr style="word-wrap:break-word"&gt;</xsl:element>
            <!-- 表格边框样式中
              第二行  第一个表格内边框的样式-->
            <xsl:element name="xsl:text">&lt;td class='table_td';&gt;</xsl:element>
            <xsl:element name="xsl:if">
        ...
        <xsl:element name="xsl:if">
          ...
          <xsl:element name="xsl:if">
            ...
            <xsl:element name="xsl:text">&lt;br/&gt;</xsl:element>
            <xsl:element name="xsl:call-template">
              <xsl:attribute name="name">set-caption</xsl:attribute>
              <xsl:element name="xsl:with-param">
                <xsl:attribute name="name">caption</xsl:attribute>
      ...
      <xsl:element name="xsl:if">
        ...
        <xsl:element name="xsl:choose">
          <xsl:element name="xsl:when">
            <xsl:attribute name="test">starts-with($normalized-string,'|')=true()</xsl:attribute>
            <xsl:element name="text">&lt;tr&gt;</xsl:element>
            <xsl:element name="text">&lt;td class='table_td';&gt;</xsl:element>
            <xsl:element name="xsl:value-of">
              <xsl:attribute name="select">substring-after($normalized-string,'|')</xsl:attribute>
            </xsl:element>
            <xsl:element name="xsl:call-template">
          ...
          <xsl:element name="xsl:otherwise">
            <xsl:element name="text">&lt;/table&gt;</xsl:element>
            <xsl:element name="xsl:call-template">
              <xsl:attribute name="name">set-table-status</xsl:attribute>
              <xsl:element name="xsl:with-param">
                <xsl:attribute name="name">status</xsl:attribute>
      ...
      <xsl:element name="xsl:if">
        ...
        <xsl:element name="xsl:choose">
          <xsl:element name="xsl:when">
            <xsl:attribute name="test">starts-with($normalized-string,'|')=true()</xsl:attribute>
            <xsl:element name="text">&lt;/td&gt;</xsl:element>
            <xsl:element name="xsl:call-template">
              <xsl:attribute name="name">set-table-status</xsl:attribute>
              <xsl:element name="xsl:with-param">
                <xsl:attribute name="name">status</xsl:attribute>
    ...
    <xsl:element name="xsl:template">
      ...
      <xsl:element name="xsl:if">
        ...
        <xsl:element name="xsl:text">&lt;th class='table_th'&gt;</xsl:element>
        <!--
        <xsl:element name="xsl:text">&lt;th 
         style="text-align:center;border-color:#AAAAAA;border-style:solid;border-width:1px;font-weight:bold;"&gt;
         </xsl:element>
        -->
        <xsl:element name="xsl:value-of">
          <xsl:attribute name="select">normalize-space($first-string)</xsl:attribute>
        </xsl:element>
        <xsl:element name="xsl:text">&lt;/th&gt;</xsl:element>
        <xsl:element name="xsl:call-template">
          <xsl:attribute name="name">display-headers</xsl:attribute>
          <xsl:element name="xsl:with-param">
            <xsl:attribute name="name">header-string</xsl:attribute>
    ...
    <xsl:element name="xsl:template">
      ...
      <xsl:element name="xsl:choose">
        <xsl:element name="xsl:when">
          ...
          <xsl:element name="xsl:text">&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;</xsl:element>
        </xsl:element>
        <xsl:element name="xsl:when">
          <xsl:attribute name="test">$table-status=2</xsl:attribute>
          <xsl:element name="xsl:text">&lt;/tr&gt;&lt;/table&gt;</xsl:element>
        </xsl:element>
        <xsl:element name="xsl:when">
          <xsl:attribute name="test">$table-status=1</xsl:attribute>
          <xsl:element name="xsl:text">&lt;/table&gt;</xsl:element>
        </xsl:element>
      </xsl:element>
      <!--end xsl:choose -->
      <xsl:element name="xsl:call-template">
    ...
    <xsl:element name="xsl:template">
      ...
      <xsl:element name="xsl:choose">
        <xsl:element name="xsl:when">
          <xsl:attribute name="test">$table-status=3</xsl:attribute>
          <xsl:element name="xsl:text">&lt;/td&gt;&lt;/tr&gt;</xsl:element>
          <xsl:element name="xsl:call-template">
            <xsl:attribute name="name">set-table-status</xsl:attribute>
            <xsl:element name="xsl:with-param">
              <xsl:attribute name="name">status</xsl:attribute>
