  ...
  <xsl:template name="make-message-template">
    ...
    <xsl:element name="xsl:stylesheet">
      ...
      <xsl:element name="xsl:template">
        ...
        <xsl:text>&lt;html class="defaultcss"&gt;&lt;style type='text/css'&gt; .defaultcss{font-size:16px;font-family:宋体;line-height:20px; } .playcode{text-indent:0px;font: 12pt '黑体'; font-weight: bold; color: block; text-align:left;} .rest{font-size:20px;font-family:黑体;font-weight:bold;text-align:center; line-height:50px; } .table_td{ text-indent:0px;border-color:#000000;border-style:solid;border-width:1px; } .table_th{ text-indent:0px;text-align:center;font-family:黑体;font-weight:bold;font-size:13pt;color:block; border-width:1px;border-color:#000000;border-style:solid; line-height:30px; } .title1{ text-indent:0px;font-size:18pt;font-family:黑体; font-weight: bold; color: black; text-align:left; line-height:40px; } .title2{ text-indent:0px;font-size:16pt;font-family:黑体; font-weight: bold; color: black; text-align:left; line-height:30px; } .text{ text-indent:0px;font-size:14pt;font-family:宋体; color:block; text-align:left; line-height:30px; } .title{ text-indent:0px;font-size:20pt;font-family:黑体; font-weight: bold; color:black; text-align:center; line-height:50px; } .table_name{text-indent:0px;font-size:16pt;font-family:黑体; font-weight: bold; color:black; text-align:center; line-height:30px; } .table_all{ border-color:#666666;border-style:solid;border-width:2px;margin-left:15px; line-height:20px;}&lt;/style&gt;</xsl:text>
        <xsl:value-of select="$cr"/>
