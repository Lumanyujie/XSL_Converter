...
!!              program.
-->
  <xsl:import href="file:/E:/jtls/mdf/utm.xsl"/>
  <xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes"/>
  <xsl:param name="language" select="'english'"/>
  <xsl:param name="gdata" select="'file:/E:/jtls/gdata'"/>
  ...
  <xsl:template name="make-message-template">
    ...
    <xsl:element name="xsl:stylesheet">
      ...
      <xsl:element name="xsl:template">
        ...
        <xsl:text>&lt;html&gt;&lt;style type='text/css'&gt;.table_td{border-color:#AAAAAA;border-style:solid;border-width:1px; }.rest{font-family:黑体;font-weight:bold;text-align:center; }.table_th{text-align:center;font-family:黑体;font-weight:bold;font-size:13pt;color:block; border-width:1px;border-color:#AAAAAA;border-style:solid; }.title1{font-size:18pt;font-family:黑体; font-weight: bold; color: black; text-align:left; }.title2{font-size:16pt;font-family:黑体; font-weight: bold; color: black; text-align:left; }.text{ text-indent:35px;font-size:14pt;font-family:宋体; color:block; text-align:left; }.title{font-size:20pt;font-family:黑体; font-weight: bold; color:black; text-align:center; }.table_name{font-size:16pt;font-family:黑体; font-weight: bold; color:black; text-align:center; }.table_all{ border-color:#666666;border-style:solid;border-width:2px;margin-left:15px; }&lt;/style&gt;</xsl:text>
        <!--border:1px; cellspacing:0px; cellpadding:1px;width:90%;
table{border:1px; cellspacing:0px; cellpadding:1px;width:90%;};
   -->
        <xsl:value-of select="$cr"/>
        ...
        <xsl:element name="xsl:if">
          ...
          <xsl:element name="xsl:if">
            ...
            <xsl:element name="xsl:if">
              ...
              <xsl:element name="xsl:text">&lt;p class="rest"&gt;</xsl:element>
              <xsl:element name="xsl:value-of">
            ...
            <!-- 整个表格边框样式-->
            <xsl:element name="xsl:text">&lt;table border="0" cellspacing="0" cellpadding="0" width="90%" class='table_all'&gt;</xsl:element>
